...
__kernel void kernel_0x3087c70_0(int param_n,int param_m,int param_p,__global float *data_b,__global float *data_a,__global float *data_c,__constant struct acc_context_t_ *context);
...
__kernel void kernel_0x3087c70_0(int param_n,int param_m,int param_p,__global float *data_b,__global float *data_a,__global float *data_c,__constant struct acc_context_t_ *context)
{
  ...
  for (local_it_i_tile_0 = context -> loops[0] . original . lower; local_it_i_tile_0 < context -> loops[0] . original . lower + context -> loops[0] . tiles[0] . length; local_it_i_tile_0 += context -> loops[0] . tiles[0] . stride) {
    ...
    for (local_it_j_tile_0 = context -> loops[1] . original . lower; local_it_j_tile_0 < context -> loops[1] . original . lower + context -> loops[1] . tiles[0] . length; local_it_j_tile_0 += context -> loops[1] . tiles[0] . stride) {
      local_it_j_worker = acc_worker_iteration(context,1,local_it_j_tile_0);
      data_c[local_it_i_gang * param_m + local_it_j_worker] = 0;
      for (local_it_k = 0; local_it_k < param_p; local_it_k += 1) {
        data_c[local_it_i_gang * param_m + local_it_j_worker] += data_a[local_it_i_gang * param_p + local_it_k] * data_b[local_it_k * param_m + local_it_j_worker];
      }
    }
  }
}
