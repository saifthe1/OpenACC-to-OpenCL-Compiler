...
size_t param_sizes_0x2276460[1] = {sizeof(unsigned long long )};
size_t scalar_sizes_0x2276460[1] = {sizeof(float )};
struct acc_loop_t_ loops_0x22513e0[1UL] = {{{16L, 0L, 0L, 0L, 32L, 1L, 1L}}};
struct acc_kernel_version_t_ version_0 = {0, 0, 1, loops_0x22513e0, "kernel_0x2276460_0"};
struct acc_kernel_version_t_ *versions[1UL] = {&version_0};
struct acc_kernel_desc_t_ kernel_desc_0_0 = {0, "", 1, param_sizes_0x2276460, 1, scalar_sizes_0x2276460, 1, 1, 1, versions, 0};
...
struct acc_compiler_data_t_ compiler_data = {"/media/ssd/projects/currents/openacc-to-opencl-compiler/libopenacc/include//../", "lib/opencl/libopenacc.cl", "/media/ssd/projects/currents/openacc-to-opencl-compiler/benchmark/103/16-0-32", 1, regions};
