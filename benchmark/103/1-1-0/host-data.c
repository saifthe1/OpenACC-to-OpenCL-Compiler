...
size_t param_sizes_0x2129310[1] = {sizeof(unsigned long long )};
size_t scalar_sizes_0x2129310[1] = {sizeof(float )};
struct acc_loop_t_ loops_0x21042c0[1UL] = {{{1L, 0L, 1L, 0L, 0L, 1L, 1L}}};
struct acc_kernel_version_t_ version_0 = {0, 0, 1, loops_0x21042c0, "kernel_0x2129310_0"};
struct acc_kernel_version_t_ *versions[1UL] = {&version_0};
struct acc_kernel_desc_t_ kernel_desc_0_0 = {0, "", 1, param_sizes_0x2129310, 1, scalar_sizes_0x2129310, 1, 1, 1, versions, 0};
...
struct acc_compiler_data_t_ compiler_data = {"/media/ssd/projects/currents/openacc-to-opencl-compiler/libopenacc/include//../", "lib/opencl/libopenacc.cl", "/media/ssd/projects/currents/openacc-to-opencl-compiler/benchmark/103/1-1-0", 1, regions};
