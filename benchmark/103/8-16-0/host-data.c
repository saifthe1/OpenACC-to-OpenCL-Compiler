...
size_t param_sizes_0x890a20[1] = {sizeof(int )};
size_t scalar_sizes_0x890a20[0] = {};
struct acc_loop_t_ loops_0xe5c260[1UL] = {{{8L, 0L, 16L, 0L, 0L, 1L, 1L}}};
struct acc_kernel_version_t_ version_0 = {0, 0, 1, loops_0xe5c260, "kernel_0x890a20_0"};
struct acc_kernel_version_t_ *versions[1UL] = {&version_0};
struct acc_kernel_desc_t_ kernel_desc_0_0 = {0, "", 1, param_sizes_0x890a20, 0, scalar_sizes_0x890a20, 3, 1, 1, versions, 0};
