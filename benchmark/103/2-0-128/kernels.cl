...
__kernel void kernel_0x968640_0(int param_n,__global float *data_a,__global float *data_c,__global float *data_b,__constant struct acc_context_t_ *context);
