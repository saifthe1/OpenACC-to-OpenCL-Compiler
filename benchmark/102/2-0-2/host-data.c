...
struct acc_loop_t_ loops_0x170d900[1UL] = {{{2L, 0L, 0L, 0L, 2L, 1L, 1L}}};
struct acc_kernel_version_t_ version_0 = {0, 0, 1, loops_0x170d900, "kernel_0x18fea40_0"};
