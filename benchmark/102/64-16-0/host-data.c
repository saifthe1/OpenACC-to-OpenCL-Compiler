...
size_t param_sizes_0x266f460[1] = {sizeof(unsigned long long )};
size_t scalar_sizes_0x266f460[1] = {sizeof(float )};
struct acc_loop_t_ loops_0x264a3e0[1UL] = {{{64L, 0L, 16L, 0L, 0L, 1L, 1L}}};
struct acc_kernel_version_t_ version_0 = {0, 0, 1, loops_0x264a3e0, "kernel_0x266f460_0"};
struct acc_kernel_version_t_ *versions[1UL] = {&version_0};
struct acc_kernel_desc_t_ kernel_desc_0_0 = {0, "", 1, param_sizes_0x266f460, 1, scalar_sizes_0x266f460, 1, 1, 1, versions, 0};
...
struct acc_compiler_data_t_ compiler_data = {"/media/ssd/projects/currents/openacc-to-opencl-compiler/libopenacc/include//../", "lib/opencl/libopenacc.cl", "/media/ssd/projects/currents/openacc-to-opencl-compiler/benchmark/102/64-16-0", 1, regions};
