...
struct acc_loop_t_ kernel_0x00_v1_loops[1] = {
  {
    ...
    (struct acc_loop_tile_t_){ e_tiling_static_iteration, 0 ,  8 }, ///!<   Gang Tile
    (struct acc_loop_tile_t_){ e_tiling_static_iteration, 0 ,  1 }, ///!< Filing Tile 1
    (struct acc_loop_tile_t_){ e_tiling_static_iteration, 0 , 64 }, ///!< Worker Tile
    (struct acc_loop_tile_t_){ e_tiling_static_iteration, 0 ,  1 }, ///!< Filing Tile 2
...
struct acc_kernel_version_t_ kernel_0x00_v1 = {
  8, 64, 1, kernel_0x00_v1_loops, "_gang_8_worker_64"
};
